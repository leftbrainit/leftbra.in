        ...
        <Wrapper class="py-12  md:py-24 lg:py-40">
            ...
            <div class=" relative  flex items-start flex-col md:flex-row  gap-8 noborder-b border-gray-500/50" :class="props.imageAlign === 'left' ? 'md:flex-row-reverse' : ''">
                <div class="flex flex-col md:w-1/2 justify-center">
                    ...
                    <div class="border-l border-white/10 pl-5 mt-5">
                        ...
                        <router-link :to="{ name: service.routeName }">
                            <li class="py-1 flex items-center group" >
                            <div v-if="service.icon" class=" material-symbols-outlined text-white/40 group-hover:text-white/60">{{ service.icon }}</div>
                            <div class="pl-3 text-xl text-white/70 group-hover:text-white/90">
                                {{ service.title }}
                            </div>
                            <div
