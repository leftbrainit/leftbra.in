<template>
    <div>
        <div  ref="bgRef" class="fixed top-0 left-0 right-0 h-[50vh] bg-primary-100 z-0 bg-center bg-cover" :style="`background-image: url(${props.headerImageUrl}); box-shadow: inset 0 -120px 100px rgba(25,25,15,1)`" v-motion
        :initial="{
          opacity: 0,
          scale:0.8
        }"
